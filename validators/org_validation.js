...
const org_schema = {
    ...
    _type:joi.string().valid('Publisher', 'Implementing').label('Organization Type'),
    _status:joi.string().valid('PENDING', 'ACTIVE', 'REJECTED', 'SUSPENDED', 'BANNED').label('Status'),
...
function create_org_validation(obj) {
    const schema = joi.object({
        ...
        _type: org_schema._type.required(),
        _status: org_schema._status.optional(),
