...
const user_schema = {
    ...
    status: joi.string().valid("PENDING", "ACTIVE", "REJECTED", "SUSPENDED", "BANNED").label("Status"),
    type: joi.string().valid("ADMIN", "PUBLISHER", "EXECUTOR", "SYSTEM_EMPLOYEE").label("Type"),
...
function create_user_validation(obj) {
    const schema = joi.object({
        ...
        status: user_schema.status.optional(),
